    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-950">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
              ...
              <CardContent>
                {recentItems.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-emerald-200 mb-4">No items yet</p>
                    <Button
                      asChild
                  ...
                  <div className="space-y-4">
                    {recentItems.map((item) => (
                      <div
                        key={item.id}
                        className="flex items-center space-x-4 p-4 rounded-xl bg-emerald-700/80 border border-emerald-600 hover:shadow-xl transition-all duration-200"
                      >
                        <div className="w-16 h-16 rounded-lg overflow-hidden bg-emerald-900 flex items-center justify-center">
                        ...
                        <Badge className="bg-emerald-500 text-white text-sm px-3 py-1 rounded-full">
                          {item.pointValue} pts
                        </Badge>
                      </div>
                    ))}
              ...
              <CardContent>
                {recentActivity.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-emerald-200">No activity yet</p>
                  </div>
                ) : (
                  <div className="space-y-4">
          ...
          <Card className="bg-emerald-700/80 dark:bg-gray-800/80 backdrop-blur-sm border-emerald-100 dark:border-emerald-800">
            <CardHeader>
